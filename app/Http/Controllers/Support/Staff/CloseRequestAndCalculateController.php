...
class CloseRequestAndCalculateController extends Controller
{
    /**
    ...
    public function __invoke(Request $request, SupportRequest $supportRequest): RedirectResponse
    {
        ...
        $user->deductCredits($supportRequest->calculateCreditsOwed());

        // We'll send the user an email as well, for their records.
